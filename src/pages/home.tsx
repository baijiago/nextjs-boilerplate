    ...
    <div className="bento-container">
          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="bento-caption text-bento-neutral-500">心理状态测评工具</p>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center gap-4">
              <Button variant="ghost" size="sm" asChild>
                <Link to="/guide" className="flex items-center gap-2">
                  <BookIcon className="w-4 h-4" />
                  <span className="bento-content-sm">操作说明</span>
                </Link>
              </Button>
              <Button variant="ghost" size="sm" asChild>
                <Link to="/science" className="flex items-center gap-2">
                  <FileIcon className="w-4 h-4" />
                  <span className="bento-content-sm">理论基础</span>
                </Link>
              </Button>
              <Button variant="ghost" size="sm" asChild>
                <Link to="/history" className="flex items-center gap-2">
                  <HistoryIcon className="w-4 h-4" />
                  <span className="bento-content-sm">测试记录</span>
                </Link>
              </Button>
              <Button variant="ghost" size="sm" asChild>
                <a
      ...
      <main className="container mx-auto px-4 py-8">
        <BentoGrid>
          ...
          <BentoWidget className="col-span-1 row-span-1">
            <div className="text-center">
              ...
              <div className="bento-caption">分钟速测</div>
            </div>
          </BentoWidget>
          ...
          <BentoWidget className="col-span-1 row-span-1">
            <div className="text-center">
              ...
              <div className="bento-caption">测试维度</div>
            </div>
          </BentoWidget>
          ...
          <BentoWidget className="col-span-1 row-span-1">
            <div className="text-center">
              ...
              <div className="bento-caption">数据安全</div>
            </div>
          </BentoWidget>
          ...
          <BentoWidget className="col-span-1 row-span-1">
            <div className="text-center">
              ...
              <div className="bento-caption">权威认证</div>
            </div>
          </BentoWidget>
          ...
          <BentoFeature className="col-span-2 md:col-span-4 lg:col-span-6 row-span-2">
            <div className="flex items-start gap-4">
              ...
              <div className="text-left space-y-3">
                <h3 className="bento-title text-bento-primary">智能匹配测试</h3>
                <p className="bento-content">
                  系统根据您的年龄和背景智能匹配最合适的测试内容，
                  为不同人群提供定制化保护措施，确保测试体验准确且舒适。
                </p>
              </div>
            </div>
          </BentoFeature>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h3 className="bento-title-sm text-bento-primary">快速版</h3>
                    <p className="bento-caption">新手推荐，快速了解</p>
                  </div>
                </div>
          ...
          <BentoCard className="col-span-2 md:col-span-2 lg:col-span-3 row-span-3">
            <div className="space-y-4">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <h3 className="bento-title-sm text-bento-secondary">完整版</h3>
                  <p className="bento-caption">深度分析，专业报告</p>
                </div>
              </div>
          ...
          <BentoCard className="col-span-1 md:col-span-2 row-span-2">
            <div className="text-center space-y-3">
              ...
              <h3 className="bento-title-sm">双维度模型</h3>
              <p className="bento-content-sm text-bento-neutral-600">
                采用权威SIS/SES双维度模型，分析抑制与激活系统
              </p>
            </div>
          </BentoCard>
          ...
          <BentoCard className="col-span-1 md:col-span-2 row-span-2">
            <div className="text-center space-y-3">
              ...
              <h3 className="bento-title-sm">心理负担评估</h3>
              <p className="bento-content-sm text-bento-neutral-600">
                使用Mosher量表，测评心理负担与道德压力
              </p>
            </div>
          </BentoCard>
          ...
          <BentoCard className="col-span-1 md:col-span-2 row-span-2">
            <div className="text-center space-y-3">
              ...
              <h3 className="bento-title-sm">羞耻感测评</h3>
              <p className="bento-content-sm text-bento-neutral-600">
                运用KISS-9量表评估羞耻体验与自我认知
              </p>
            </div>
          </BentoCard>
          ...
          <BentoCard className="col-span-1 md:col-span-2 row-span-2">
            <div className="text-center space-y-3">
              ...
              <h3 className="bento-title-sm">态度调研</h3>
              <p className="bento-content-sm text-bento-neutral-600">
                SOS量表检测情绪反应与行为倾向
              </p>
            </div>
          ...
          <BentoFeature className="col-span-2 md:col-span-4 lg:col-span-6 xl:col-span-8 row-span-2">
            <div className="text-center space-y-4">
              ...
              <h2 className="bento-title text-bento-primary">隐私保护是我们的核心承诺</h2>
              <p className="bento-content max-w-3xl mx-auto">
                所有测试数据均在本地处理存储，绝不上传外部服务器。
                您享有完整数据控制权，可随时删除或导出记录。
              </p>
        ...
        <section className="text-center mt-16 space-y-6">
          <h2 className="text-3xl font-bold text-bento-neutral-800">准备好探索内心世界了吗？</h2>
          <p className="bento-content max-w-2xl mx-auto">
            通过科学自测，深入了解自我，提升心理健康与人际关系品质。
          </p>
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              ...
              <p className="bento-content-sm text-bento-neutral-600">
                科学心理测评平台，助您深度了解内心状态与心理健康水平。
              </p>
            </div>

            <div>
              <h4 className="bento-title-sm mb-3">测评工具</h4>
              <ul className="space-y-2">
                <li><Link to="/assessment?type=quick" className="bento-content-sm text-bento-neutral-600 hover:text-bento-primary">快速测试</Link></li>
                <li><Link to="/assessment?type=full" className="bento-content-sm text-bento-neutral-600 hover:text-bento-primary">完整测试</Link></li>
                <li><Link to="/history" className="bento-content-sm text-bento-neutral-600 hover:text-bento-primary">测试记录</Link></li>
              </ul>
            </div>

            <div>
              <h4 className="bento-title-sm mb-3">帮助</h4>
              <ul className="space-y-2">
                <li><Link to="/guide" className="bento-content-sm text-bento-neutral-600 hover:text-bento-primary">操作说明</Link></li>
                <li><Link to="/science" className="bento-content-sm text-bento-neutral-600 hover:text-bento-primary">理论基础</Link></li>
                <li><a href="#" className="bento-content-sm text-bento-neutral-600 hover:text-bento-primary">隐私条款</a></li>
              </ul>
            </div>

            <div>
              <h4 className="bento-title-sm mb-3">联系</h4>
              <ul className="space-y-2">
                <li><a href="#" className="bento-content-sm text-bento-neutral-600 hover:text-bento-primary">问题解答</a></li>
                <li><a href="#" className="bento-content-sm text-bento-neutral-600 hover:text-bento-primary">咨询服务</a></li>
                <li><a href="#" className="bento-content-sm text-bento-neutral-600 hover:text-bento-primary">紧急帮助</a></li>
              </ul>
            </div>
          </div>
          ...
          <div className="border-t border-bento-neutral-200 mt-8 pt-8 text-center">
            <p className="bento-content-sm text-bento-neutral-500">
              © 2025 心理压力测评系统. 仅用于教育和自我认知，无法替代专业心理服务。
            </p>
          </div>
        </div>
      </footer>
