...
import {CheckCircleIcon, CopyIcon, MessageIcon, ShareIcon, PhoneIcon} from '@/components/ui/icons';
      ...
      <SheetContent side="bottom" className="h-auto max-h-[80vh] overflow-y-auto">
        <SheetHeader>
          <SheetTitle className="flex items-center gap-2">
            <ShareIcon className="w-5 h-5 text-psychology-primary" />
            分享我的评估结果
          </SheetTitle>
          <SheetDescription>
            选择您喜欢的方式分享SRI评估结果
        ...
        <div className="space-y-6 mt-6">
          ...
          <div className="grid grid-cols-2 gap-3">
            ...
            >
              <MessageIcon className="w-8 h-8 text-green-600" />
