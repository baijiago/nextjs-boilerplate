...
import {AlertIcon, ArrowLeftIcon, BrainIcon, CheckCircleIcon, HomeIcon} from '@/components/ui/icons';
        ...
        <AlertDialogContent className="max-w-[calc(100%-2rem)] sm:max-w-sm rounded-xl p-6 space-y-6">
          <AlertDialogHeader className="space-y-3 text-center">
            ...
            <AlertDialogDescription className="text-sm text-muted-foreground">
              检测到本地保存的未完成测试，已回答 {pendingProgress?.responses.length ?? 0} 道题。请选择继续作答或重新开始。
            </AlertDialogDescription>
          </AlertDialogHeader>
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <BrainIcon className="w-5 h-5 text-psychology-primary" />
                <span className="font-semibold text-psychology-primary">
                  {assessmentType === 'quick' ? '快速测试' : '完整测试'}
                </span>
              </div>
            </div>
            ...
            <Card className="sri-card p-12">
              <div className="space-y-6">
                <div className="w-16 h-16 bg-psychology-primary/10 rounded-full flex items-center justify-center mx-auto">
                  <BrainIcon className="w-8 h-8 text-psychology-primary animate-pulse" />
                </div>
          ...
          <div className="container mx-auto">
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-2 text-xs sm:text-sm text-muted-foreground">
                <AlertIcon className="w-3 h-3 sm:w-4 sm:h-4" />
